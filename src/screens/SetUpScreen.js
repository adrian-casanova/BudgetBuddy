        ...
        if(setUpOne === true && setUpTwo === false && setUpThree === false && setUpFour === false){
            ...
            return(
                ...
                onSwipeLeft = {async (state) => {
                   ...
                   await this.calculateDailyBudget();
                   await this._storeDailyBudget(this.state.budget);
            ...
            height : '20%'
                    ...
                    animation = 'fadeIn'
                    style = {{
                        height : '80%', width  : width - 20, 
                        top : '10%',
                        justifyContent : 'flex-start',
                        alignItems : 'center'
                    }}>
                    <View style = {{height : 50, width : '85%',left : '2%',
                    ...
                    justifyContent : 'space-between'}} >
                        ...
                        <View style = {{
                            ...
                            <TextInput 
                             onEndEditing = {() => {
                                this.setState({
                                    totalExpenses : this.state.totalExpenses + parseInt(this.state.rentCost)
                                })
                            }}
                            keyboardType = 'number-pad'
                            returnKeyType = 'done'
                    ...
                    justifyContent : 'space-between'}} >
                        ...
                        onEndEditing = {() => {
                            this.setState({
                                totalExpenses : this.state.totalExpenses + parseInt(this.state.billsCost)
                            })
                        }}
                                style = {{
                                    width : 100,
                    ...
                    justifyContent : 'space-between'}} >
                        ...
                        <View style = {{
                            ...
                            <TextInput 
                             onEndEditing = {() => {
                                this.setState({
                                    totalExpenses : this.state.totalExpenses + parseInt(this.state.savingsCost)
                                })
                            }}
                            underlineColorAndroid = 'transparent'
                            keyboardType = 'number-pad'
                    ...
                    <View 
                        style = {{
                            height : 4, backgroundColor : 'white',
                            width : '80%',
                            top : '15%'
                        }}
                    />
                    <View 
                    style = {{height : 50, width : '80%',left : '2%',
                    top : '28%',
                    alignSelf : 'center', flexDirection : 'row', alignItems : 'center',
